...
export const AdminStoreProductsView: React.FC<AdminStoreProductsViewProps> = ({
  ...
  return (
    <div className="space-y-6 font-sans">
      {/* Header & Actions — Directly on Admin Background */}
      ...
      {filtered.length === 0 ? (
        ...
        /* Table List View — Natural Height */
          ...
          <table className="w-full text-left text-xs font-mono border-collapse">
            <thead>
              <tr className="border-b-2 border-slate-200 text-slate-500 uppercase tracking-wider">
                ...
                <th className="py-3 px-2 font-bold">License</th>
            ...
            <tbody className="divide-y divide-slate-100">
              {filtered.map((prod) => (
                <tr key={prod.id} className="hover:bg-slate-100/70 transition-colors group">
                  ...
                  <td className="py-3.5 px-2 font-bold text-slate-700">{prod.category}</td>
                  <td className="py-3.5 px-2 font-extrabold text-slate-900">₹{prod.price}</td>
                  <td className="py-3.5 px-2 text-slate-600">{prod.licenseType || 'Lifetime License'}</td>
                  <td className="py-3.5 px-2">
                    <span
