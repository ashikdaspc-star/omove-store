  ...
  return (
    <aside className="fixed bottom-[calc(58px+env(safe-area-inset-bottom,8px))] sm:bottom-6 right-3 sm:right-6 z-40" aria-label="WhatsApp Support">
      <a
        ...
        className="group flex items-center gap-2 px-3 py-1.5 min-[360px]:px-3.5 min-[360px]:py-2 sm:px-4.5 sm:py-2.5 rounded-full bg-white border border-slate-200/90 hover:border-emerald-300 shadow-md hover:shadow-xl text-slate-800 hover:text-emerald-700 transition-all duration-200 hover:scale-105 active:scale-95 font-sans"
      >
        <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-emerald-500 text-white flex items-center justify-center shrink-0 shadow-xs group-hover:bg-emerald-600 transition-colors">
