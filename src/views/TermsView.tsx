...
export const TermsView: React.FC = () => {
  const sections = [
    ...
    { num: 4, title: 'Digital Product Access', body: 'Purchased digital product license keys and download links are delivered electronically via your customer account dashboard and email.' },
    { num: 5, title: 'Software Licensing', body: 'Digital software keys grant non-exclusive, personal or commercial licenses according to the specific license terms (e.g. Lifetime License, Single PC).' },
    ...
    { num: 7, title: 'Refunds', body: 'Refund requests are evaluated under our Refund & Return Policy. Digital products revealed or activated are non-returnable except for verified defects.' },
    { num: 8, title: 'Prohibited Use', body: 'Users must not engage in fraudulent purchase attempts, unauthorized license redistribution, or malicious site exploitation.' },
