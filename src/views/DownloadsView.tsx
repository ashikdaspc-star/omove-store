...
export const DownloadsView: React.FC<DownloadsViewProps> = ({
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 sm:px-5 md:px-6 lg:px-8 py-8 space-y-8 font-sans">
      {/* Top Banner */}
      <div className="scroll-reveal p-6 md:p-8 rounded-2xl bg-white border border-slate-200/90 shadow-xs space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          <div className="space-y-2 max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200 text-xs font-bold font-sans">
              <Download className="w-3.5 h-3.5 text-emerald-600" />
              <span>DIGITAL DOWNLOAD CENTER</span>
            </div>
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-sans">
              Access your purchased digital files, utilities, and software downloads.
            </p>
          </div>

          <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0">
            <div className="p-4 rounded-xl bg-emerald-50/60 border border-emerald-200/80 text-center space-y-0.5 w-full sm:w-auto">
              <span className="text-[11px] text-slate-500 uppercase font-bold block">Purchased Downloads</span>
        ...
        {/* Search & Category Bar */}
        <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4 relative z-10">
          {/* Search Bar */}
