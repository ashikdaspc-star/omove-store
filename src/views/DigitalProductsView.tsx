...
import { Search, ShoppingBag, CheckCircle2, Zap, ShieldCheck } from 'lucide-react';
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200/90 shadow-xs space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs sm:text-sm text-slate-600 font-sans max-w-2xl">
              Explore our digital products and software solutions with instant access after purchase.
            </p>
          </div>
        ...
        <div className="pt-3 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="relative w-full sm:max-w-md">
            ...
            <input
              type="text"
              placeholder="Search digital products & software..."
              value={searchQuery}
